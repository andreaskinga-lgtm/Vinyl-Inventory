// PROTOTYPE — throwaway. Variant C: "Listening Room".
// Thesis: no top chrome at all. Every control lives in one floating dock at the
// bottom, with Flip as the primary affordance in the centre. Detail never
// overlays: the tapped sleeve expands *inline* into the grid on its own row, so
// on mobile there is no floating box that can resize or jump.
import {
  useCallback,
  useEffect,
  useLayoutEffect,
...
export const name = "Listening Room";
...
function InlineDetail({ record, onClose }) {
